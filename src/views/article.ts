...
export function pttArticlePage(d: ArticleDetail): string {
  ...
  return pttLayout(
    ...
    d.boardName,
    `<div class="ptt-container ptt-pt40 ptt-pb56 article-page">
...
<div class="article-bottombar"><div class="ptt-container"><a href="/bbs/${esc(d.boardName)}/index.html" class="back-to-board">返回看板</a></div></div>`,
  );
}
...
<span class="c-f3">${esc(p.userId)}</span>
